...
import com.epam.jwd.core_final.exception.CrewMemberUnavailableException;
...
public interface CrewService {
    ...
    void assignCrewMemberOnMission(CrewMember crewMember) throws CrewMemberUnavailableException;

    // todo create custom exception for case, when crewMember is not able to be created (for example - duplicate.
    // crewmember unique criteria - only name!
    CrewMember createCrewMember(CrewMember crewMember) throws DuplicateEntityObjectException;
}